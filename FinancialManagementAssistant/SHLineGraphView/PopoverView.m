...
- (void)showAtPoint:(CGPoint)point inView:(UIView *)view withText:(NSString *)text
{
    ...
    CGSize textSize = [text boundingRectWithSize:CGSizeMake(screenSize.width - kHorizontalMargin*4.f, 1000.f) options:NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:attribute context:nil].size;
...
- (void)showAtPoint:(CGPoint)point inView:(UIView *)view withContentView:(UIView *)cView {
   ...
   _topView =  [UIApplication sharedApplication].delegate.window.rootViewController.view;
    _topView.tag = 1000;
