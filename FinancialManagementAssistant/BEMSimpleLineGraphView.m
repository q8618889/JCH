...
- (void)drawGraph {
    ...
    CGFloat xDot1 = 0.0; // Postion on the X-axis of the first dot.
    CGFloat yDot1 = 0.0; // Postion on the Y-axis of the first dot.
    CGFloat xDot2 = 0.0; // Postion on the X-axis of the next dot.
    CGFloat yDot2 = 0.0; // Postion on the Y-axis of the next dot.
    ...
    for (int i = 0; i < numberOfPoints - 1; i++) {
        ...
        for (UIView *dot in [self.viewForBaselineLayout subviews]) {
            if (dot.tag == i + 100)  {
                xDot1 = (CGFloat)dot.center.x;
                yDot1 = (CGFloat)dot.center.y;
            } else if (dot.tag == i + 101) {
                xDot2 = (CGFloat)dot.center.x;
                yDot2 = (CGFloat)dot.center.y;
            }
        }
